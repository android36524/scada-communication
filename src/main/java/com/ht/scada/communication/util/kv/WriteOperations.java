 ...
 * com.ht.scada.data.com.ht.scada.data.kv migration takes place in this test, since com.ht.scada.data.com.ht.scada.data.kv migration changes record
 ...
 * application due to other client activity and com.ht.scada.data.com.ht.scada.data.kv migration, as well as
 * network failures.
 * <p>
...
public class WriteOperations {
     ...
     * Version to a Key/Value pair when migrating com.ht.scada.data.com.ht.scada.data.kv for better resource
