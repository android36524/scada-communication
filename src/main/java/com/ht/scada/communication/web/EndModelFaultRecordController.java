...
public class EndModelFaultRecordController implements IGTVGController {

    public EndModelFaultRecordController() {
        super();
    }
    ...
    public void process(
        ...
        templateEngine.process("faultRecord", ctx, response.getWriter());
    }
