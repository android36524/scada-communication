...
public class EndModelYxRecordController implements IGTVGController {

    public EndModelYxRecordController() {
        super();
    }
    ...
    public void process(
        ...
        templateEngine.process("yxRecord", ctx, response.getWriter());
    }
