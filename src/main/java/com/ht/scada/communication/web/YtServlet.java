 ...
 */
@WebServlet(urlPatterns = {"/yt"})
public class YtServlet extends HttpServlet {
    private static final Logger log = LoggerFactory.getLogger(YtServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (pass != null && pass.equals("ht19928")) {
            ...
            int value = Integer.parseInt(request.getParameter("value").trim());
            ...
            if (communicationChannel.exeYT(endCode, varName, value)) {
