...
//        final DataInputStream dis = new DataInputStream(bais);
//        try {
//			com.ht.scada.data.com.ht.scada.data.kv.setValue(dis.readDouble());
//			com.ht.scada.data.com.ht.scada.data.kv.setChange(dis.readDouble());
//		} catch (IOException e) {
//            throw new RuntimeException(e);
//		}
//        return com.ht.scada.data.com.ht.scada.data.kv;
	}
}
