...
@Controller
@Singleton
public class EndModelController extends AbstractController {

    @Inject
    public EndModelController(TemplateEngine templateEngine) {
        super(templateEngine);
    }

    @Path("/endTag") @ThymeleafView("endTag")
    public void endTag(HttpServletRequest request)
            throws Exception {
    ...
    public void endTagHistory(HttpServletRequest request) throws Exception {
